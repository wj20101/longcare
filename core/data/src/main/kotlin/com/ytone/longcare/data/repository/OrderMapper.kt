...
object OrderMapper {
    ...
    fun UserInfoM.toOrderElderInfoEntity(orderId: Long): OrderElderInfoEntity {
        return OrderElderInfoEntity(
            orderId = orderId,
            elderUserId = userId,
            elderName = name.orEmpty(),
            elderIdCard = identityCardNumber.orEmpty(),
            elderAge = age,
            elderGender = gender.orEmpty(),
            elderAddress = address.orEmpty(),
            elderLng = lng.orEmpty(),
            elderLat = lat.orEmpty(),

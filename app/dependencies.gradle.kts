...
dependencies {
    ...
    addAll(
        ...
        listOf(
            ...
            lib("room-ktx"),
            lib("retrofit-core"),
            lib("retrofit-converter-kotlinx-serialization"),
            lib("okhttp-core"),
            ...
            lib("androidx-camera-video"),
            lib("androidx-camera-view"),
            lib("androidx-camera-extensions"),
            lib("androidx-camera-compose"),
            lib("face-detection"),

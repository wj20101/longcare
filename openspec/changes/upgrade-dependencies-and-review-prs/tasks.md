...
- [ ] 4.2a 按追加确认核对 AGP/Gradle 稳定版兼容组合，保留 9.4.1/9.7.1；Kotlin 合入后以 Wrapper 生成任务同步 JAR/启动脚本及 properties，验证官方 SHA-256、实际运行版本、build-logic 测试、双应用 Debug/Lint 和完整 preflight；独立 PR 最新 CI 通过后按授权合入，不采用预览版或移除校验。

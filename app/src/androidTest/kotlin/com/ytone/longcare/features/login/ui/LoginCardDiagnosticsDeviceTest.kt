...
class LoginCardDiagnosticsDeviceTest {
    ...
    fun tapping_logo_does_not_open_validation_entries() {
        ...
        composeRule.onNodeWithText("打开助手").assertDoesNotExist()
    }

    @Test
    fun cancelling_long_press_confirmation_keeps_login_working() {
        ...
        composeRule.onNodeWithText("打开助手").assertExists()

...
import com.ytone.longcare.network.processor.ThirdKeyDecryptor
import com.ytone.longcare.network.processor.ThirdKeyDecryptorImpl
import dagger.Binds
...
abstract class ResponseProcessorModule {
    ...
    @Binds
    @Singleton
    abstract fun bindThirdKeyDecryptor(
        impl: ThirdKeyDecryptorImpl
    ): ThirdKeyDecryptor

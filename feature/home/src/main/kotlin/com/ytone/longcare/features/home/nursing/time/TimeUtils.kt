package com.ytone.longcare.features.home.nursing.time
...
internal data class DisplayDate(
    val timestamp: Long,
...
internal enum class DisplayDayLabel(@param:StringRes val labelRes: Int) {

...
@Preview
@Composable
internal fun PlanListEmptyPreview() {
    PlanList(plans = emptyList(), isLoading = false, onGoToDetailClick = {})
}

@Preview
@Composable
internal fun PlanListWithSingleItemPreview() {
    val plans = listOf(
        ServiceOrderModel(
            orderId = 1L,
            name = "John Doe",
...
@Composable
internal fun PlanListPreviewEmpty() {
    LongCareTheme {
        PlanList(plans = emptyList(), isLoading = false, onGoToDetailClick = {})
    }
}
...
@Preview(showBackground = true)
@Composable
internal fun PlanListPreviewWithData() {

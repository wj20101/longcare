...
require_pattern "${ROOT_DIR}/.github/workflows/android-ci.yml" ":feature:home:pixel6Api36DebugAndroidTest" "android-ci keeps Home API 36 smoke scoped to the Home feature test APK"
...
require_pattern "${ROOT_DIR}/.github/workflows/android-ci.yml" "needs\.detect-affected\.outputs\.run_home_feature_instrumentation == 'true'" "android-ci Home instrumentation remains affected-gated"
...
require_pattern "${ROOT_DIR}/.github/workflows/android-ci.yml" "if:[[:space:]]*needs\.detect-affected\.outputs\.run_instrumentation == 'true' \|\| needs\.detect-affected\.outputs\.run_home_feature_instrumentation == 'true' \|\| needs\.detect-affected\.outputs\.run_login_feature_instrumentation == 'true'" "android-ci current-target emulator job remains affected-gated"
...
require_pattern "${ROOT_DIR}/.github/workflows/android-ci.yml" 'validation_scopes\+=[(]"app-focused"[)]' "android-ci summary distinguishes app-focused validation"
require_pattern "${ROOT_DIR}/.github/workflows/android-ci.yml" 'validation_scopes\+=[(]"home-feature-focused"[)]' "android-ci summary distinguishes Home-feature-focused validation"
require_pattern "${ROOT_DIR}/.github/workflows/android-ci.yml" 'validation_scopes\+=[(]"login-feature-focused"[)]' "android-ci summary distinguishes login-feature-focused validation"
...
require_pattern "${ROOT_DIR}/.github/workflows/android-ci.yml" "Home feature focused result" "android-ci API 36 report records Home feature focused execution separately"
...
require_pattern "${ROOT_DIR}/scripts/quality/quality_gate_registry.json" '"id":[[:space:]]*"real_device_acceptance_evidence"' "quality gate registry declares real-device acceptance evidence"
...
require_pattern_count "${ROOT_DIR}/scripts/quality/test_android_build_governance.sh" "bash .*test_real_device_acceptance_evidence\\.sh" "1" "android build governance runs real-device acceptance fixtures once"
...
require_absent_pattern "${ROOT_DIR}/scripts/quality/preflight_local.sh" "test_real_device_acceptance_evidence\\.sh" "local preflight does not duplicate real-device acceptance fixtures outside its umbrella"
...
require_pattern_count "${ROOT_DIR}/.github/workflows/android-ci.yml" "bash scripts/quality/test_real_device_acceptance_evidence\\.sh" "1" "android-ci runs real-device acceptance fixtures once"
...
require_pattern_count "${ROOT_DIR}/.github/workflows/android-release.yml" "bash scripts/quality/test_real_device_acceptance_evidence\\.sh" "1" "android-release runs real-device acceptance fixtures once"
require_pattern_count "${ROOT_DIR}/.github/workflows/baseline-profile.yml" "bash scripts/quality/test_real_device_acceptance_evidence\\.sh" "1" "baseline-profile runs real-device acceptance fixtures once"

...
import com.ytone.longcare.features.home.ui.EmptyView
            ...
            0 -> {
                ...
                if (pendingOrders.isNotEmpty()) {
                    ...
                    EmptyView(
                        ...
                        message = stringResource(CoreUiR.string.dashboard_empty_pending_care_plans),
                    )
                }
            }

...
- 候选 `7676e2d9` 经 [PR #131](https://github.com/wj20101/longcare/pull/131) 合入 master `f73fff386dc180217bfb1594314dbbfc5da4bc1d`，两者源码树一致。PR 的 [Android CI](https://github.com/wj20101/longcare/actions/runs/35442319600) 和 [SDK 切换检查](https://github.com/wj20101/longcare/actions/runs/35442319680) 全部通过；[master CI](https://github.com/wj20101/longcare/actions/runs/35442969930) 首次在 KVM 权限准备阶段失败，未运行应用测试，重跑失败任务后所有检查通过，没有放宽检查或改业务代码。
- 最终产物为 `app/build/outputs/apk/release/app-release.apk` 和 `app/build/outputs/bundle/release/app-release.aab`，哈希与上述最终记录一致；只完成源码提交/合入和本地产物交付，没有上传商店、更新服务或创建分发 Release。原有未跟踪缓存未纳入提交。
